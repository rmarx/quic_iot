...
class PacketProcessor(object):
    ...
    def _process_packet_helper(self, pkt):
        ...
        # elif sc.UDP in pkt and (pkt[sc.IP].src == '192.168.5.6' or pkt[sc.IP].dst == '192.168.5.6'):
        #     print('udp', len(pkt), pkt[sc.IP].src, pkt[sc.IP].dst, pkt[sc.UDP].sport, pkt[sc.UDP].dport)
