...
# mode:
# 0 for pre-processing data at Android phone
# 1 for processing mean and divation here
MODE = 0
FIAT = FIATHandler(mode=0)
...
class HttpRequestHandler:
    def __init__(
        ...
        *,
        ...
        if stream_ended:
            ...
            print("stream_ended", self.stream_id, self.transmit)
    ...
    def http_event_received(self, event: H3Event) -> None:
        if isinstance(event, DataReceived):
            ...
            # print('DataReceived', event.data)
            print('DataReceived', len(event.data))
            try:
                FIAT.new_data(json.loads(event.data))
            except:
                pass
            ...
            print('HeadersReceived', event.headers)
...
class SessionTicketStore:
    ...
    def add(self, ticket: SessionTicket) -> None:
        ...
        # print('SessionTicketStore.add', ticket)
        # print()
        # print()

    def pop(self, label: bytes) -> Optional[SessionTicket]:
        # print('SessionTicketStore.pop', label)
        # print()
        # print()
